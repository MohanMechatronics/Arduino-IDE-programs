...
<div>
  <span>TILT :</span>
  <input type="range" min="0" max="180" value="90" class="slider" id="Tilt" oninput='Tilt_value(this.value),sendButtonInput("Tilt",value)'>
...
<div>
  <span>Link1 :</span>
  <input type="range" min="0" max="180" value="90" class="slider" id="Link1" oninput='Link1_value(this.value),sendButtonInput("Link1",value)'>
...
<div >
  <span>Link2 :</span>
  <input type="range" min="0" max="180" value="90" class="slider" id="Link2" oninput='Link2_value(this.value),sendButtonInput("Link2",value)'>
