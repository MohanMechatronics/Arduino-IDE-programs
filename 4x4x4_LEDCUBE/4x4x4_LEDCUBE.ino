...
#define BLYNK_TEMPLATE_ID "TMPL3g6iMIIpj"
#define BLYNK_TEMPLATE_NAME "Everything is fine"
#define BLYNK_AUTH_TOKEN "kwASXl8ZG5nr_Xtj_cJRl9uCMmaTOWQv"// key to access the cloud aut= authorisation token
...
void setup()
{
  ...
  Blynk.begin(auth, ssid, password);// imp for iot
