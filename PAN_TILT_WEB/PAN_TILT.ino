...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <div align=center>
        <img id="cameraImage" src="" style="width:350px;height:250px">
        </div>
<DIV class="sliders">
<div>
  <span >PAN:</span>     
...
<div>
  <span>LINK1:</span>
  <input type="range" min="0" max="180" value="90" class="slider" id="Link1" oninput='sendButtonInput("Link1",value)'>
</div>
<div >
  <span>LINK 2:</span>
  <input type="range" min="0" max="180" value="90" class="slider" id="Link2" oninput='sendButtonInput("Link2",value)'>
</div>
...
void setUpPinModes()
{
  dummyServo1.attach(12);
  dummyServo2.attach(13);  
